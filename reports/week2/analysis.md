...
- **Byte Counting Accuracy (US-002 / US-016)**: While packet counting is straightforward, accurate byte volume counting (distinguishing between payload, headers, and total frame size) requires further technical investigation.
...
- **MVP v1 Scope Adherence**: Development for the upcoming sprint will be strictly limited to the confirmed `Must Have` stories: **US-001**, **US-002**, **US-004**, **US-005**, **US-009**, and **US-014**.
