...
- **MVP version tracking:** all PBIs that implemented user stories selected for our [MVP v1 scope](../week2/user-stories.md#initial-proposed-mvp-v1-scope) were marked as "MVP v1." We used a filtered table view on Github to keep track of these PBIs and ensure that we fully implemented and delivered everything within the scope.
